...
id_vendedores INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
-- tabelas geradas a partir do relacionamento n:m entre as tabelas principais:
  ...
  CREATE TABLE vendedores_atendem_cliente (
id_cliente INT NOT NULL,
id_conta INT NOT NULL,
id_vendedores INT NOT NULL,
PRIMARY KEY (id_cliente, id_conta, id_vendedores)
);

Alter table vendedores_atendem_cliente
...
Add constraint fk_vd_id_vendedores FOREIGN KEY (id_vendedores) REFERENCES vendedores(id_vendedores);
...
Insert into vendedores (nome_completo, CPF_CNPJ, contato)
Values
	('João Campos', 98767854614, 91996387997), 
    ('Julia Mota Barros', 67598723415, 89986751433),
    ('Marcos Paz Saraiva', 06789870526, 71946541427);

INSERT INTO vendedores_atendem_cliente (id_cliente, id_conta, id_vendedores)
VALUES
	();
